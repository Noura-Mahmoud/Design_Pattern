...
namespace DoFactory.HeadFirst.Observer.WeatherStationObservable
{
    ...
    public class Observable
    {
        ...
        delegate void observerDelegate(object subject);
        event observerDelegate MeasurementsChange;
        //private List<IObserver> _observers = new List<IObserver>();

        public void AddObserver(IObserver observer)
        {
            //_observers.Add(observer);
            MeasurementsChange += observer.Update;
        }
        ...
        {
            MeasurementsChange?.Invoke(this);
